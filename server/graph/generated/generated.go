...
func (ec *executionContext) field_Mutation_loginUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNLoginUser2githubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐLoginUser(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_refreshToken_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNRefreshTokenData2githubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐRefreshTokenData(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_parseTokenData(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTokenData2ᚖgithubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐTokenData(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNLoginUser2githubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐLoginUser(ctx context.Context, v interface{}) (model.LoginUser, error) {
...
func (ec *executionContext) marshalNTokenData2githubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐTokenData(ctx context.Context, sel ast.SelectionSet, v model.TokenData) graphql.Marshaler {
	return ec._TokenData(ctx, sel, &v)
}

func (ec *executionContext) marshalNTokenData2ᚖgithubᚗcomᚋfadhiilrachmanᚋeᚑbpmᚋgraphᚋmodelᚐTokenData(ctx context.Context, sel ast.SelectionSet, v *model.TokenData) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
